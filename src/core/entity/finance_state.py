...
class State(TypedDict):
    ...
    executed_order: Annotated[Union[dict, None], keep_first]
    investment_execution: Annotated[Optional[str], keep_first]
    awaiting_approval: Annotated[Optional[bool], keep_first]
    approved: Annotated[Optional[bool], keep_first]
